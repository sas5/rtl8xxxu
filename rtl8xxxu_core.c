...
static
int rtl8xxxu_get_antenna(struct ieee80211_hw *hw, int radio_idx, u32 *tx_ant, u32 *rx_ant)
{
	struct rtl8xxxu_priv *priv = hw->priv;
...
static int rtl8xxxu_set_rts_threshold(struct ieee80211_hw *hw, int radio_idx, u32 rts)
{
